...
const supabase = createClient(process.env.SUPABASE_PUBLIC_URL!, process.env.SUPABASE_SERVICE_ROLE_KEY!)// ! assures typescript the values are defined at runetime
